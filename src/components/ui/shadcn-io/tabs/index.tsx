    ...
    return (
        <MotionHighlightItem value={ value } className="size-full">
            <motion.button
                ...
                className={ cn(
                    'inline-flex cursor-pointer items-center size-full justify-center whitespace-nowrap rounded-sm px-2 ' +
                    'py-1 text-sm font-medium ring-offset-background transition-transform focus-visible:outline-none ' +
                    'focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none ' +
                    'disabled:opacity-50 data-[state=active]:text-foreground z-[1]',
                    className,
                ) }
                { ...props }
            >
